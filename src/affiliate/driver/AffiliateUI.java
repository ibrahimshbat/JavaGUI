...
public class AffiliateUI {
	...
	protected void createContents() {
		...
		shlUpdate.setSize(1065, 300);
		shlUpdate.setImage(SWTResourceManager.getImage(AffiliateUI.class, "/resources/ebe.png"));
		...
		button.setBounds(619, 604, 130, 39);
		...
		button_1.setBounds(667, 152, 92, 52);
